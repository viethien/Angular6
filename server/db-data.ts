...
export const COURSES = {
    0: {
        id: 0,
        description: "Angular Ngrx Course.ts",
    ...
    2: {
        id: 2,
        description: 'Angular Security Course.ts - Web Security Fundamentals',
    ...
    3: {
        id: 3,
        description: 'Angular PWA - Progressive Web Apps Course.ts',
    ...
    4: {
        id: 4,
        description: 'Angular NgRx Store Reactive Extensions Architecture Course.ts',
    ...
    6: {
        id: 6,
        description: 'The Complete Typescript Course.ts',
    ...
    7: {
        id: 7,
        description: 'Rxjs and Reactive Patterns Angular Architecture Course.ts',
    ...
    8: {
        id:8,
        description: "Angular Material Course.ts",
...
export const LESSONS = {
    ...
    11: {
        id: 11,
        "description": "Course.ts Helicopter View",
        "duration": "08:19",
        "seqNo": 1,
        courseId: 2
    },
    ...
    19: {
        id: 19,
        "description": "User.ts Sign Up Server-Side Implementation in Express",
        "duration": "08:50",
        "seqNo": 9,
        courseId: 2
    },
    ...
    22: {
        id: 22,
        "description": "Course.ts Kick-Off - Install Node, NPM, IDE And Service Workers Section Code",
        "duration": "07:19",
        "seqNo": 1,
        courseId: 3
    },
    ...
    30: {
        id: 30,
        "description": "Welcome to the Angular Ngrx Course.ts",
        "duration": "6:53",
        "seqNo": 1,
        courseId: 0
    ...
    31: {
        id: 31,
        "description": "The Angular Ngrx Architecture Course.ts - Helicopter View",
        "duration": "5:52",
        "seqNo": 2,
        courseId: 0
    },
